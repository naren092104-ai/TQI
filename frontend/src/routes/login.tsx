...
function LoginPage() {
  ...
  const s = useStore();
  const [email, setEmail] = useState("demo@tqi.org");
          ...
          <Card className="w-full max-w-md shadow-glow">
            <CardContent className="p-8">
              ...
              <div className="mt-6 space-y-2 text-center text-xs text-muted-foreground">
                <div>Demo account: <strong>demo@tqi.org</strong> / <strong>Admin@123</strong></div>
                <div>Demo build · <Link to="/" className="font-medium text-primary hover:underline">Skip to dashboard</Link></div>
              </div>
            </CardContent>
          </Card>
        </div>
